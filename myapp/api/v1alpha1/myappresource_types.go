...
type MyAppResourceSpecResource struct {
...
type MyAppResourceSpec struct {
	...
	SpecReplicaCount *int32                    `json:"replicaCount"`
	SpecResource     MyAppResourceSpecResource `json:"resources"`
	SpecImage        MyAppResourceSpecImage    `json:"image"`
	SpecUI           MyAppResourceSpecUI       `json:"ui"`
	SpecRedis        MyAppResourceSpecRedis    `json:"redis"`
}
